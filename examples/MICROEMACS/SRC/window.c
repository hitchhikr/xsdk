...
int f, n;   /* arguments are ignored for this command */
{
    ...
    register WINDOW *cwp;   /* copy of curwp */
    ...
    {
        cwp=curwp;
        cwp->w_bufp->b_dotp = cwp->w_dotp;
        cwp->w_bufp->b_doto = cwp->w_doto;
        cwp->w_bufp->b_markp = cwp->w_markp;
        cwp->w_bufp->b_marko = cwp->w_marko;
    }
...
shrinkwind(f, n)
{
    ...
    if (curwp->w_ntrows <= n || curwp->w_ntrows <= 2)
    {
        mlwrite("Impossible change");
        return (FALSE);
    }
